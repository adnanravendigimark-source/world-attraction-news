...
// Legacy route. Articles live at /[country]/[city]/[slug] now (see
// lib/destinations.ts) — this pre-restructure URL shape is no longer linked
// to from anywhere on the site, but real visitors
