...
// Used across the Admin Panel and contributor dashboard for a consistent
// success/error signal after an action — separate from any inline form
// validation errors, which still render next to their own field.
