          ...
          <div className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-2xl bg-white p-6 shadow-2xl space-y-5">
            ...
            <div className="space-y-4">
              ...
              <ImageUploadField
                ...
                altLabel="City Cover Image Alt Text"
                altPlaceholder={`Describe cover photo (e.g. Skyline view of ${form.name || "this destination"})`}
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (existingCountryInfo) {
                        openEditCountryModal(existingCountryInfo);
                      }
                    }}
                    className="shrink-0 rounded-lg border border-slate-200 bg-white px-3 py-1 text-[11px] font-bold text-slate-700 hover:bg-slate-50 transition-colors"
                  >
            ...
            <div className="flex items-center justify-end gap-2 border-t border-slate-200 p-4">
              ...
              <button
                ...
                className="rounded-lg bg-[#DC2626] px-5 py-2 text-xs font-bold uppercase tracking-wider text-white shadow-md hover:bg-[#B91C1C] transition-all disabled:opacity-50 cursor-pointer"
              >
            ...
            <div className="space-y-3.5">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-200 bg-slate-100 px-3 py-1.5 text-xs text-slate-500 cursor-not-allowed"
                />
              </div>
              ...
              <div>
                ...
                />
                <p className="mt-1 text-[10px] text-slate-400">
                  Public URL: /{editingCountry.slug}
                </p>
              </div>

              <div>
                <label className="block text-[11px] font-bold uppercase tracking-wider text-slate-700 mb-1">
                  Country Overview Summary (Displayed on /{editingCountry.slug})
                </label>
                <textarea
              ...
              <ImageUploadField
                ...
                altValue={editingCountry.heroImageAlt}
                onAltChange={(alt) => setEditingCountry({ ...editingCountry, heroImageAlt: alt })}
                altLabel="Country Cover Image Alt Text"
                altPlaceholder={`Describe cover photo (e.g. Scenic landscape of ${editingCountry.name || "country"})`}
                uploadUrl="/api/admin/upload"
              />
