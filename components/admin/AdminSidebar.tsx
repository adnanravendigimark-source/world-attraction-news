  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { href: "/admin/sitemaps", label: "Sitemaps", icon: "sitemaps", pageKey: "sitemaps" },
      ],
    },
    {
      label: "System",
...
function NavIcon({ name }: { name: string }) {
  const paths: Record<string, string> = {
    ...
    sitemaps: "M3.6 9h16.8M3.6 15h16.8M11.5 3a17 17 0 000 18M12.5 3a17 17 0 010 18M12 3a9 9 0 100 18 9 9 0 000-18z",
